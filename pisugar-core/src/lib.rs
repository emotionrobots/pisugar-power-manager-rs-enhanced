...
/// PiSugar configuration definition
...
///--------------------------------------------
///  Detect button tap given the GPIO history
///--------------------------------------------
...
impl PiSugarCore {
    ...
    ///--------------------------------------------
    ///  Bind instance to battery type and init
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Return average battery intensity 
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Return true if battery allows charging 
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Returns the battery charging range 
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Sets the battery charging range 
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Write current time to RTC time 
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Return true if read RTC alarm is enabled 
    ///--------------------------------------------
    ...
    ///--------------------------------------------
    ///  Poll for taps; call system function if
    ///  enabled; return tap type
    ///--------------------------------------------
    pub fn poll(&mut self, now: Instant) -> Result<Option<TapType>> {
        log::info!("lib: PiSugar2 poll called");
        ...
        if let Some(tap_type) = tap {
            log::info!("lib: got tap");
            let script = match tap_type {
                TapType::Single => {
                    log::info!("lib: PiSugar2 single press");
                ...
                TapType::Double => {
                    log::info!("PiSugar2 double press");
        ...
        log::info!("PiSugar2 poll returning");
        Ok(tap)
    }
}
