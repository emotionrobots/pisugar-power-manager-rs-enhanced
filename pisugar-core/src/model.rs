...
///  model.rs
///
///  Class abstraction handling binding of different battery
///  models.
///
///============================================================
...
impl Model {
    ...
    ///------------------------------------------------
    ///  Return number of LEDs givn the model 
    ///------------------------------------------------
    ...
    ///------------------------------------------------
    /// Query I2C to see which PiSugar battery model
    ///------------------------------------------------
...
///-------------------------------------------------------------
///  Implement fmt::Display for Model string 
///-------------------------------------------------------------
